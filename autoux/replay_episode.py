...
def main():
    ...
    parser.add_argument("--dump-human-readable", action="store_true",
                       help="Dump episode data in human-readable format")

    args = parser.parse_args()

    try:
        replayer = EpisodeReplayer(args.mcap_file)
        if args.dump_human_readable:
            replayer.dump_human_readable()
        else:
